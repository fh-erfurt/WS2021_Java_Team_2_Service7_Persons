...
class PersonAvatarTest {
    ...
    void testConverterImageToByteArray() throws IOException {
        ...
        //TODO: @Prof. Dr. Avemarg - The Maven-Git pipeline could not find our directory for the image,that we used for the unit purpose. When you are checking out our project please ensure to exclude the comment in the PersonAvatar Unit-Test. Also Please checkout our 6.2. Potential Bugs Java 2 in the Documenatation!
        /*
        //when + given
